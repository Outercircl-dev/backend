...
export class ProfileService {
  ...
  async updateProfile(userId: string, input: ProfileUpdateInput) {
    ...
    if (input.distanceRadiusKm !== undefined)
      updateData.distance_radius_km = input.distanceRadiusKm;
        ...
        details: [
          {
            ...
            code: 'invalid_format',
            message:
              'Username must be 3-15 characters and contain only lowercase letters, numbers, or underscores',
          },
        ],
