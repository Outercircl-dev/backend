...
export function validate(config: Record<string, unknown>) {
  const schema = Joi.object({
    ...
    AWS_S3_ACTIVITY_IMAGES_BUCKET: Joi.string().optional(),
    AWS_S3_ACTIVITY_IMAGES_PUBLIC_BASE_URL: Joi.string().uri().optional(),
    AWS_S3_ACTIVITY_IMAGES_KEY_PREFIX: Joi.string().optional(),
  });
